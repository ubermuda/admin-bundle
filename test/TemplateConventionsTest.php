...
{
    /**
     * Tailwind arbitrary values (`z-[100]`) are baked into the bundle and cannot
     * be re-themed by the consuming app, which owns the Tailwind pass. Use the
     * standard scale, or a CSS custom property in assets/admin.css.
     */
